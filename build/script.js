...
(function (ControlButton) {
    ControlButton["NEWGAME"] = "New game";
    ControlButton["GENERATE"] = "Generate";
...
//game instance
let game = new Game(canvas, (mainSection.clientWidth > 750) ? mainSection.clientWidth - aside.clientWidth : main.clientWidth, main.clientHeight);
...
window.addEventListener('resize', () => game = new Game(canvas, (mainSection.clientWidth > 750) ? mainSection.clientWidth - aside.clientWidth : main.clientWidth, main.clientHeight));
